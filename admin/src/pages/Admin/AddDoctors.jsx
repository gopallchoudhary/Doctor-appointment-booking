...
const AddDoctors = () => {
  ...
  return (
    <form onSubmit={submitHandler} className="w-full m-5">
      <p className="text-lg mb-3 font-medium">Add doctor</p>

      <div className="px-8 py-8 bg-white border rounded max-w-4xl max-h-[80vh] overflow-y-scroll">
        {/* Up */}
        <div className="flex items-center gap-3 mb-8 text-gray-500">
          <label htmlFor="doc-img">
            <img
              className="w-16 border-gray-100 cursor-pointer"
        ...
        <button type="submit" className="bg-primary text-white px-10 py-3 mt-4 rounded-full">
          Add doctor
        </button>
      </div>
    </form>
